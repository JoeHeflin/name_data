...
class Complete7Test {
    ...
    void singleName() throws Exception {
        int[] years = {3000,3004};
        List<String> actualNames = Complete7.namesAtRank(years,"F",5);
    ...
    void multipleNames() throws Exception {
        int[] years = {3000,3004};
        List<String> actualNames = Complete7.namesAtRank(years,"F",1);
    ...
    void invalidRank(){
        int[] years = {3000,3004};
        assertThrows(Exception.class, ()->{Complete7.namesAtRank(years,"F",13);});
    }
